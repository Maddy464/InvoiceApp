sap.ui.define([
	...
	"invoiceui/model/formatter",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/MessageToast",
	"sap/m/MessageBox",
	  "sap/ui/core/routing/History"
], function (Controller, JSONModel, formatter, Filter, FilterOperator, MessageToast, MessageBox,History) {
	"use strict";

	return Controller.extend("invoiceui.controller.Worklist", {
		...
		onInit : function () {
			...
			oViewModel = new JSONModel({
				...
				shareOnJamTitle: this.getOwnerComponent().getModel("i18n").getResourceBundle().getText("worklistTitle"),
				shareSendEmailSubject: this.getOwnerComponent().getModel("i18n").getResourceBundle().getText("shareSendEmailWorklistSubject"),
				shareSendEmailMessage: this.getOwnerComponent().getModel("i18n").getResourceBundle().getText("shareSendEmailWorklistMessage", [location.href]),
	...
	onPressInvoicewf: function (oEvent) {

       var oRouter = this.getOwnerComponent().getRouter();
	   let ID = oEvent.getSource().getBindingContext().getProperty('ID');
